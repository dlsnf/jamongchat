...
function finish_effect(e,a)
{
	...
	if( a == 1 ) //시간 연장
	{
		...
		if(mobile_check){
			...
			$("body, html").animate({scrollTop:$(".con_img_"+e).offset().top - $(".top").height()-130 },100 , 'easeOutExpo',function(){
			});
...
var like_light_box_chk= 0;
	...
	function write_start(e)
	{
		...
		var prepend_body = "<div class='iframe_div' style='position:absolute; z-index:999999;top:0; left:0; width:100%; height:100%; display: none; '><iframe src='http://jamongserver.cafe24.com/jamongchat/write_iframe/write_iframe.php?seq="+e+"&toppx="+toppx+"&board="+board_type+"' class='light_iframe' allowtransparency='true' frameborder='0' width='100%' height='100%' style='position:absolute; z-index:999999;  top:0; left:0;'></iframe></div>";
	...
	function profile_start(e)
	{
		...
		var prepend_body = "<div class='iframe_div' style='position:absolute; z-index:999999; top:0; left:0; width:100%; height:100%; display: none; '><iframe src='http://jamongserver.cafe24.com/jamongchat/profile_iframe/profile_iframe.php?seq="+e+"&toppx="+toppx+"' class='light_iframe' allowtransparency='true' frameborder='0' width='100%' height='100%' style='position:absolute; z-index:999999;  top:0; left:0;'></iframe></div>";
	...
	function light_iframe_start(e)
	{
		...
		var prepend_body = "<div class='iframe_div' style='position:absolute; z-index:999999; top:0; left:0; width:100%; height:100%; display: none; '><iframe src='http://jamongserver.cafe24.com/jamongchat/light_iframe/light_box_iframe.php?seq="+e+"&toppx="+toppx+"' class='light_iframe' allowtransparency='true' frameborder='0' width='100%' height='100%' style='position:absolute; z-index:999999;  top:0; left:0;'></iframe></div>";
	...
	function profile_light_iframe_start(e)
	{
		...
		var prepend_body = "<div class='iframe_div_profile' style='position:absolute; z-index:9999999; top:0; left:0; width:100%; height:100%; display: none; '><iframe src='http://jamongserver.cafe24.com/jamongchat/profile_light_iframe/profile_light_iframe.php?seq="+e+"&toppx="+toppx+"' class='light_iframe' allowtransparency='true' frameborder='0' width='100%' height='100%' style='position:absolute; z-index:999999;  top:0; left:0;'></iframe></div>";
	...
	function like_iframe_start(e,status)
	{
		...
		var prepend_body = "<div class='iframe_div_like' style='position:absolute; z-index:9999999; top:0; left:0; width:100%; height:100%; display: none; '><iframe src='http://jamongserver.cafe24.com/jamongchat/like_iframe/like_iframe.php?seq="+e+"&toppx="+toppx+"&status="+status+"' class='light_iframe' allowtransparency='true' frameborder='0' width='100%' height='100%' style='position:absolute; z-index:999999;  top:0; left:0;'></iframe></div>";
