       ...
       !strcmp($extension,"inc") ||
        ...
        if($degree) { 
            if($exifData[FileType] == 1) { 
				...
				//디비등록
				$up_chack = 2;				
				$sqlInsert = "INSERT INTO jamong_chat_freeboard (user_seq, body, like_c, photo_way, photo, date, ip) VALUES ('$user_seq', '$get_write_body', '0', 'http://jamongserver.cafe24.com/jamongchat/write_iframe/upload/up_img/$file_name_web', '$file_name_web', '$date', '$get_ip')";
