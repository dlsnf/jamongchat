...
{
	$board_name = "자유게시판";
}else if($board_type2 == 'free')
{
	$board_name = "자유게시판";
}else if($board_type2 == 'fashion')
{
	$board_name = "패션";
}else if($board_type2 == 'selfie')
{
	$board_name = "셀피";
}else if($board_type2 == 'food')
{
	$board_name = "음식";
}else if($board_type2 == 'photo')
{
	$board_name = "사진";
}else{
	echo "잘못된 경로입니다";
...
<div class="all-wrap">
			...
			<div class="light_box">
				...
				<form id="myForm" name="myForm" action="file_db.php" method="post" accept-charset="utf-8" ENCTYPE="multipart/form-data">
					...
					<div class="fb_login_info">※ 일부 앱 내부 브라우저로 파일 업로드가 안될 수도 있습니다<br>기본 웹 브라우저로 실행하세요</div>
