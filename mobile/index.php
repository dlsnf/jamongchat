...
<ul  class="board_menu_ul">
	<div class="board_menu_info">< 포럼 ></div>
	
	<li><a href="board.php?board=free&mobile=<?=$mobile_check2?>" class="btn_board free_board">자유게시판 <?=$free_board_count?></a></li>

	<li><a href="board.php?board=fashion&mobile=<?=$mobile_check2?>" class="btn_board fashion_board">패션 <?=$fashion_board_count?></a></li>

	<li><a href="board.php?board=selfie&mobile=<?=$mobile_check2?>" class="btn_board selfie_board">셀피 <?=$selfie_board_count?></a></li>

	<li><a href="board.php?board=food&mobile=<?=$mobile_check2?>" class="btn_board food_board">음식 <?=$food_board_count?></a></li>

	<li><a href="board.php?board=photo&mobile=<?=$mobile_check2?>" class="btn_board photo_board">사진 <?=$photo_board_count?></a></li>
